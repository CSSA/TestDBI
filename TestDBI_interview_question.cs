...
namespace TestDBI
{
     class TestDBI_interview_question
    {
        ...
        static void TestDBI_T_interview_question_AutoCheck()
        {
            ...
            iResult = TestDBI_T_interview_question_AutoCheck_WriteRead();
            if (iResult == 0)
            ...
            iResult = TestDBI_T_interview_question_AutoCheck_Update();
            if (iResult == 0)
                Console.WriteLine("OK: TestDBI_T_interview_question_AutoCheck_Update");
            else
                Console.WriteLine("ERROR: TestDBI_T_interview_question_AutoCheck_Update:    iResult=" + iResult);
        ...
        /// <summary>
        /// TestDBI_T_interview_question_AutoCheck_Update - Update Item List;
        /// 1.1) Create test data: myTable1;
        /// 1.2) Clear DBTable;
        /// 1.3) Write myTable1 to DBTable; 
        /// 1.4) Get DBTable.CountRows, compare (myTable1.itemList.Count == DBTable.CountRows)
        ...
        /// </summary>
        /// <returns></returns>
        static int TestDBI_T_interview_question_AutoCheck_Update()
        {
            const int OK = 0;
            int iResult = OK;
            Console.WriteLine("START: TestDBI_T_interview_question_AutoCheck_Update()");
            ...
            /// 1.7) Create the update table (myTableUpdate)
            interview_question_Table myTableUpdate = new interview_question_Table();
            myTableUpdate.itemList = new List<interview_question>()
            {
             //  interview_question(String val_interviewQuestions, String val_questionNotes, int val_sessionId)
            new interview_question("question_1", "notes_1", 1),
            new interview_question("question_1", "notes_1", 2),
            ...
            //1.9) Read myTable3
            interview_question_Table myTable3 = new interview_question_Table();
            myTable3.ReadItemListFromDatabase();


            //1.10) Compare tables.itemLists (myTableUpdate == myTable3)
            if (!TestDBI_T_interview_question_CompareLists(myTableUpdate.itemList, myTable3.itemList))
            {
                iResult = -1;
            ...
            Console.WriteLine("DONE: TestDBI_T_interview_question_AutoCheck_Update()");
            return iResult;
        }
