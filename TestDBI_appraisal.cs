     ...
     class TestDBI_appraisal
    {
        ...
        static void TestDBI_T_appraisal_AutoCheck()
        {
            ...
            int iResult;
             ...
             iResult = TestDBI_T_appraisal_AutoCheck_WriteRead();
            if (iResult == 0)
            ...
            iResult = TestDBI_T_appraisal_AutoCheck_Update();
            if (iResult == 0)
                Console.WriteLine("OK: TestDBI_T_appraisal_AutoCheck_Update");
            else
                Console.WriteLine("ERROR: TestDBI_T_appraisal_AutoCheck_Update:    iResult=" + iResult);
        ...
        /// <summary>
        /// TestDBI_T_appraisal_AutoCheck_Update - Update Item List;
        /// 1.1) Create test data: myTable1;
        /// 1.2) Clear DBTable;
        /// 1.3) Write myTable1 to DBTable; 
        /// 1.4) Get DBTable.CountRows, compare (myTable1.itemList.Count == DBTable.CountRows)
        ...
        /// </summary>
        /// <returns></returns>
        static int TestDBI_T_appraisal_AutoCheck_Update()
        {
            const int OK = 0;
            int iResult = OK;
            Console.WriteLine("START: TestDBI_T_appraisal_AutoCheck_Update()");
            ...
            /// 1.7) Create the update table (myTableUpdate)
            appraisal_Table myTableUpdate = new appraisal_Table();
            myTableUpdate.itemList = new List<appraisal>()
            {
               // appraisal(String val_appraisalName, String val_creator, int val_maturityLevel, int val_currentProject, string val_projects, bool val_samSelected, bool val_ssdSelected)
            new appraisal("appraisalName_1", "s_creator_1", 1, 1, "projects_1", true, true),
            new appraisal("appraisalName_2", "s_creator_2", 2, 2, "projects_2_modified", true, true),
            new appraisal("appraisalName_3", "s_creator_3", 3, 3, "projects_3", true, true),
            new appraisal("appraisalName_4", "s_creator_4", 4, 4, "projects_4_modified", true, true),
            new appraisal("appraisalName_5", "s_creator_5", 5, 5, "projects_5", true, true),
            };
            ...
            //1.9) Read myTable3
            appraisal_Table myTable3 = new appraisal_Table();
            myTable3.ReadItemListFromDatabase();


            //1.10) Compare tables.itemLists (myTableUpdate == myTable3)
            if (!TestDBI_T_appraisal_CompareLists(myTableUpdate.itemList, myTable3.itemList))
            {
                iResult = -1;
            ...
            Console.WriteLine("DONE: TestDBI_T_appraisal_AutoCheck_Update()");
            return iResult;
        }
