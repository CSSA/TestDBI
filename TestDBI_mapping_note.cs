...
namespace TestDBI
{
    class TestDBI_mapping_note
    {
        ...
        static void TestDBI_T_mapping_note_AutoCheck()
        {
            ...
            iResult = TestDBI_T_mapping_note_AutoCheck_WriteRead();
            if (iResult == 0)
            ...
            iResult = TestDBI_T_mapping_note_AutoCheck_Update();
            if (iResult == 0)
                Console.WriteLine("OK: TestDBI_T_mapping_note_AutoCheck_Update");
            else
                Console.WriteLine("ERROR: TestDBI_T_mapping_note_AutoCheck_Update:    iResult=" + iResult);
